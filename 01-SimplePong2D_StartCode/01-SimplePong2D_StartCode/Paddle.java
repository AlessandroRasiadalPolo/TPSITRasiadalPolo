...
public class Paddle {
     ...
     */
    public boolean checkCollision(Ball b, JPanel gamePanel){

        //if the ball hits the paddle his x would be greater than the paddle's x
        //I have two different cases

        //I'm checking the paddle on the right
        if(this.x > gamePanel.getWidth() /2)
           return b.getX() + b.getSize() > this.x && this.y < b.getY() && b.getY() < this.y + this.height;

        //I'm checking the paddle on the left
        else
            return b.getX() < this.x + PADDLE_WIDTH && this.y < b.getY() + b.getSize() && b.getY() < this.y + this.height;
